      ...
      <div className="px-6 pt-4 flex-1 flex flex-col">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <p className="text-white/70 text-sm max-w-[280px] mx-auto">
            Acesso ilimitado à inteligência artificial do Dr. Viva e planos alimentares personalizados.
          </p>
        </div>
        ...
        <div className="space-y-4 mb-8 relative z-10">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs leading-relaxed">Tire dúvidas de saúde 24/7 com a IA treinada pelo Dr. Viva.</p>
            </div>
          </div>
        </div>
